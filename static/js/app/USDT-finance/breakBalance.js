$(function() {
    ...
    reqApi({
        ...
        lists.forEach(function(d){
        	//平台冷钱包
        	if(d.accountNumber=="SYS_ACOUNT_USDT_COLD"){
        		$("#amount-TG").text(moneyFormat(d.amountString,'','USDT'));
        		accountNumberTG = d.accountNumber;
        	}
        	//平台盈亏账户
        	if(d.accountNumber=="SYS_ACOUNT_USDT"){
        		$("#amount-CNY").text(moneyFormat(d.amountString,'','USDT'));
