$(function() {
    ...
    var fields = [{
        ...
        title: '取现金额',
        formatter: function(v, data) {
            return moneyFormatSC(data.withdraw.amountString);
        },
        readonly: true
    }, {
        field: 'feeString',
        title: '手续费',
        formatter: function(v, data) {
            return moneyFormatSC(data.withdraw.feeString);
        },
        readonly: true
    }, {
        field: 'amount',
        ...
        formatter: function(v, data) {
            ...
            return moneyFormatSC(amount.subtract(feeString).toString());
        },
        readonly: true
    }, {
        field: 'payFeeString',
        title: '实际支付矿工费',
        formatter: function(v, data) {
            return moneyFormatSC(data.withdraw.payFeeString);
        },
        readonly: true
    }, {
        field: 'channelType',
